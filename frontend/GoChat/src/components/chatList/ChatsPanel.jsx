...
export function ChatsPanel() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`ltr:border-r-2 rtl:border-l-2 h-full border-gray-200 dark:border-gray-700 flex flex-col max-h-full ${isChatsPanelCollapsed ? "hidden" : "animate-slideup"} `}
      >
        <SearchBar
          name="name"
          query={query}
