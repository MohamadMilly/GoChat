...
export default function Features() {
  ...
  return (
    <>
      ...
      <section className="flex items-center justify-between flex-wrap gap-10 max-w-200 mx-auto pb-6 border-b dark:border-gray-800 border-gray-200 my-6">
        <article className="text-lg font-rubik text-gray-700 dark:text-gray-200 basis-2xs h-full flex-1">
          {t[language].Item1}
        </article>
        <aside className="flex justify-center items-center rounded bg-gray-400/5 w-full max-w-100 h-100 shrink-0">
          <img className="" src={feature1Image} alt="feature 1 preview" />
        </aside>
      </section>
      <section className="flex items-center justify-between flex-wrap gap-10 max-w-200 mx-auto pb-6 border-b border-gray-200 dark:border-gray-800 my-6">
        <article className="text-lg font-rubik text-gray-700 dark:text-gray-200 basis-2xs h-full flex-1">
          {t[language].Item2}
        </article>
        <aside className="flex justify-center items-center rounded bg-gray-400/5 w-full max-w-100 h-100 shrink-0">
